...
public class EbooksFaculty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ebooks_faculty);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(!snapshot.exists()){
                    ...
                    deleteEbook.setLayoutManager(new LinearLayoutManager(EbooksFaculty.this));
                    adapter=new EbooksAdapter(list,EbooksFaculty.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(EbooksFaculty.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}